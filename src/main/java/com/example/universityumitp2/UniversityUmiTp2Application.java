package com.example.universityumitp2;

import com.example.universityumitp2.entities.Product;
import com.example.universityumitp2.repository.ProductRepository;
...
public class UniversityUmiTp2Application implements CommandLineRunner {

    @Autowired
    private ProductRepository productRepository;
    public static void main(String[] args) {
        SpringApplication.run(UniversityUmiTp2Application.class, args);
    }
